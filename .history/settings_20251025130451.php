...
if ($hassiteconfig) {
    ...
    // Проверяем наличие права certificateelement/autonumber:manage перед добавлением кнопки пересчёта.
    $context = context_system::instance();
    if (has_capability('certificateelement/autonumber:manage', $context)) {
        $url = new moodle_url('/admin/certificateelement_autonumber/recalculate.php');
